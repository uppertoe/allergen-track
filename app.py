...
# Allergens list
allergens = ["Wheat", "Dairy", "Raw Egg", "Cooked Egg", "Rice", "Oat", "Soy", "Sesame", "Seeds", "Shellfish", "Fish", "Peanuts", "Almond", "Hazelnut", "Cashew", "Macadamia", "Pistachio", "Pine Nut", "Other Treenuts"]
